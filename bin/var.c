...
void InitVariables() {
  init_var("FLARINGINDEX", (char*)&FLARINGINDEX, REAL, NO, "0.5");
  init_var("SIGMASLOPE", (char*)&SIGMASLOPE, REAL, NO, "1.0");
  init_var("YMAX", (char*)&YMAX, REAL, NO, "1.5");
  init_var("THICKNESSSMOOTHING", (char*)&THICKNESSSMOOTHING, REAL, NO, "0.1");
  init_var("OMEGAFRAME", (char*)&OMEGAFRAME, REAL, NO, "1.0");
  init_var("ZMIN", (char*)&ZMIN, REAL, NO, "1.42079632679489661922");
  ...
  init_var("ALPHA", (char*)&ALPHA, REAL, NO, "1.0e-2");
  init_var("ASPECTRATIO", (char*)&ASPECTRATIO, REAL, NO, "0.05");
  init_var("YMIN", (char*)&YMIN, REAL, NO, "0.6");
  init_var("SIGMA0", (char*)&SIGMA0, REAL, NO, "6.3661977237e-4");
  init_var("ZMAX", (char*)&ZMAX, REAL, NO, "1.57079632679489661922");
  init_var("NX", (char*)&NX, INT, NO, "100");
  init_var("NY", (char*)&NY, INT, NO, "80");
  init_var("NZ", (char*)&NZ, INT, NO, "20");
  init_var("NINTERM", (char*)&NINTERM, INT, NO, "10");
  init_var("NTOT", (char*)&NTOT, INT, NO, "10001");
  init_var("PLOTLINE", (char*)&PLOTLINE, STRING, NO, "field[-1,:,:]");
  init_var("PLANETCONFIG", (char*)&PLANETCONFIG, STRING, NO, "planets/SuperEarth.cfg");
  init_var("SETUP", (char*)&SETUP, STRING, NO, "p3diso");
  init_var("OUTPUTDIR", (char*)&OUTPUTDIR, STRING, NO, "@outputs/p3diso");
